...
import 'package:google_ml_kit_example/view/screens/instructions/moneydetc.dart';
...
class Qibla0 extends StatefulWidget {

  @override
  State<Qibla0> createState() => _Qibla0State();
}

class _Qibla0State extends State<Qibla0> {
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      speakText("This button Assists users in determining the direction of the Qibla with audio guidance, ideal for prayer.");
                    },
                    child: Column(
                      children: [
