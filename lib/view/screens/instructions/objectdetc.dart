...
import 'package:google_ml_kit_example/view/screens/instructions/extractetxt4mimage.dart';

import '../../../model/move/move.dart';
import '../../../model/utils/appimages.dart';
import '../../../model_view/cubit/soundpool/cubit/sound_cubit.dart';



class Objectdetc extends StatefulWidget {

  @override
  State<Objectdetc> createState() => _ObjectdetcState();
}

class _ObjectdetcState extends State<Objectdetc> {
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      speakText("This button unlocks a world of information for you. Use Object Detection to receive audio descriptions of objects in your surroundings. helping you navigate your environment with confidence and independence.");
                    },
                    child: Column(
                      children: [
                  ...
                  Container(
                    ...
                    child: InkWell(
                      ...
                      onDoubleTap: (){
                        Move.move(context,  Extractetxt4mimage());
                      },
                      child:  Row(
