...
class Colordetc extends StatefulWidget {

  @override
  State<Colordetc> createState() => _ColordetcState();
}

class _ColordetcState extends State<Colordetc> {
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      speakText("This button Identifies dominant colors in captured image using voice description.");
                    },
                    child: Column(
                      children: [
