...
import 'package:google_ml_kit_example/view/screens/instructions/colordetc.dart';
...
class Extractetxt4mimage extends StatefulWidget {

  @override
  State<Extractetxt4mimage> createState() => _Extractetxt4mimageState();
}

class _Extractetxt4mimageState extends State<Extractetxt4mimage> {
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      speakText("This button Transforms written information in your surroundings into spoken words. Simply capture an image of text.");
                    },
                    child: Column(
                      children: [
