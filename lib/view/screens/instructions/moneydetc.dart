...
import 'package:google_ml_kit_example/view/screens/instructions/translation_.dart';
...
class Moneydetc extends StatefulWidget {

  @override
  State<Moneydetc> createState() => _MoneydetcState();
}

class _MoneydetcState extends State<Moneydetc> {
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      speakText("This button uses a verb associated with audio feedback and clearly implies identifying paper money through the button.");
                    },
                    child: Column(
                      children: [
                        SizedBox(height: 50.h,),
                        SizedBox(height: 10.h,),
                        Text("Money Detection",
                          style:  TextStyle(
                            color: Colors.white,
                            fontSize: 30.sp,
